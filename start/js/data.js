...
const infoList = [
  ...
  {
    name: '<ORNT>',
    desc: 'ORNT는 이상적인 피부타입 입니다. 피지량에 따라 보습제 사용이 필요 없을 수도 있습니다.  <br> <관리방법> ORNT'
  },
  {
    name: '<ORNW>',
    desc: ''
  ...
  {
    name: '<DSPW>',
    desc: 'DSPW는 재발성 피부 염증, 고르지 않은 피부 색조 및 주름살 성향을 나타냅니다.'
  },
  {
    name: '<DSNW>',
    desc: 'DSNW는 피부 건조 및 염증이 주된 특징입니다. DSNW는 피부 톤을 균일하게하지만 주름이 생기기 쉽습니다. '
  },
  {
    name: '<DSPT>',
    desc: 'DSPT는 재발하는 피부 염증과 고르지 않은 피부톤을 특징으로합니다. '
  },
  {
    name: '<DRPW>',
    desc: 'DRPW는 피부 건조증, 불균일 한 색소 침착 및 주름에 대한 민감성이 주된 특징인 피부 입니다.'
  },
  {
    name: '<DRNW>',
    desc: 'DRNW는 피부 톤이 균일하지만 건조하고 주름이 생기기 쉽습니다.'
  },
  {
    name: '<DRPT>',
    desc: 'DRPT는 피부 건조증과 색소 침착이 주된 특징이며 염증이 거의없고 주름이 거의 없습니다.'
  },
  {
    name: '<DRNT>',
    desc: '피부 건조증은 피부 톤을 최소화하고 주름을 최소화하는 이 피부 타입의 주된 특징입니다. '
  },
  {
    name: '<OSPT>',
    desc: 'OSPT는 염증과 고르지 않은 피부 색조의 발작으로 고통받습니다. '
  },
  {
    name: '<OSPW>',
    desc: 'OSPW는 피부 염증, 불균일 한 안료 및 주름 경향이 있습니다.'
  },
  {
    name: '<OSNW>',
    desc: 'OSNW는 염증을 가지고 있으며 피부 노화에 취약합니다.'
  },
  {
    name: '<OSNT>',
    desc: 'OSNT는 유성과 염증을 특징으로합니다. <br>OSNT는 항산화가 풍부한 피지가 보호 효과가 있기 때문에 주름에 덜 취약합니다.'
  },
]
