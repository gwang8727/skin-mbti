...
const infoList = [
  {
    ...
    context: 'ORPT타입은 자외선에 민감하므로 자외선 차단제를 필수적으로 사용해야 합니다. 특히, 건조한 피부가 아니기 때문에 사용감이 가벼운 선크림이 좋습니다. <br> 피부톤을 위해서는 나이아신아마이드 또는 비타민 C와 비타민E가 같이 함유된 제품을 사용하는 것이 좋습니다. 의사의 진단에 따라 하이드로퀴논도 사용할 수 있습니다. '
  },
  {
    name: '<ORNT>',
    desc: 'ORNT는 이상적인 피부타입 입니다. 피지량에 따라 보습제 사용이 필요 없을 수도 있습니다.',
    context : ' <관리방법> ORNT타입은 피지때문에 블랙헤드와 화이트헤드 같은 문제가 발생할 수 있습니다. <br> 이를 없애기 위해 물리적 필링 스크럽 또는 강한 알칼리성 세정제보단 BHA, PHA사용을 권장합니다. BHA와 PHA는 화학적 각질 제거제로 농도에 따라 효과와 자극이 커지므로, 낮은 농도부터 시작해야 합니다. <br> 피부에 너무 강한 자극이 지속되면 ORPT의 피부타입이 OSPT로 바뀔 수 있으므로 주의해야 합니다. 의사의 진단에 따라 피지분비가 많은 부위에 아다팔렌이 함유된 의약품을 사용할 수 있습니다.'
  },
  {
    name: '<ORNW>',
    desc: 'ORNW는 자극과 햋빛에 민감한 피부는 아니지만, 주름이 있는 피부타입 입니다.',
    context : '<관리방법> ORNW타입은 햋빛에 민감하지 않지만, 자외선이 주름을 발생하기 때문에 사용감이 가벼운 자외선 차단제를 사용해야 합니다. '
  },
  {
    name: '<ORPW>',
    desc: '',
